...
struct IngredientsView: View {
    ...
    let ingredients : [CollectionViewImage] = [CollectionViewImage(type: "Ingredient", title: "Spaghetti"), CollectionViewImage(type: "Ingredient", title: "Angel Hair"), CollectionViewImage(type: "Ingredient", title: "Linguini"), CollectionViewImage(type: "Ingredient", title: "Garlic"), CollectionViewImage(type: "Ingredient", title: "Tomato"), CollectionViewImage(type: "Ingredient", title: "Salt"), CollectionViewImage(type: "Ingredient", title: "Onion"), CollectionViewImage(type: "Ingredient", title: "Thyme"), CollectionViewImage(type: "Ingredient", title: "Oregano"), CollectionViewImage(type: "Ingredient", title: "Parsley"), CollectionViewImage(type: "Ingredient", title: "Basil"), CollectionViewImage(type: "Ingredient", title: "Black Pepper"), CollectionViewImage(type: "Ingredient", title: "Bread Crumbs"), CollectionViewImage(type: "Ingredient", title: "Ground Beef"), CollectionViewImage(type: "Ingredient", title: "Crushed Red Pepper Flakes"), CollectionViewImage(type: "Ingredient", title: "Pasta Shells"), CollectionViewImage(type: "Ingredient", title: "Macaroni"), CollectionViewImage(type: "Ingredient", title: "Cheddar Cheese"), CollectionViewImage(type: "Ingredient", title: "Swiss Cheese"), CollectionViewImage(type: "Ingredient", title: "Parmesan Cheese"), CollectionViewImage(type: "Ingredient", title: "Butter"), CollectionViewImage(type: "Ingredient", title: "Mozarella"), CollectionViewImage(type: "Ingredient", title: "Italian Bread"), CollectionViewImage(type: "Ingredient", title: "Olive Oil")]
    ...
    var body: some View {
        ...
        CollectionView(images: filteredIngredients, activeIngredients: $activeIngredients)
    }
}
